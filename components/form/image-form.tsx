...
interface ImageUploadFormProps {
  ...
  return (
    <div className="mb-6">
    {!preview ? (
      <div className="flex flex-col items-center h-[300px] justify-center border-2 border-dashed border-gray-300 rounded-md p-4 hover:border-gray-500 transition-all duration-200 relative">
